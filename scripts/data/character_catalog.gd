...
# `texture` is the character's own art in assets/sprites.
...
static func _definitions() -> Array[Dictionary]:
	return [
		{"name":"RIFT RUNNER", "texture":"char_runner", "description":"Balanced survivor", "cost":0,
			"hp":100.0, "speed":290.0, "slots":6, "kinds":[], "weapon":"pistol",
			"stats":{}, "color":Color("5eead4")},
		{"name":"ARCANE WARDEN", "texture":"char_warden", "description":"Glass cannon mage", "cost":30,
			"hp":80.0, "speed":280.0, "slots":6, "kinds":[], "weapon":"wand",
			"stats":{"damage":22.0, "crit_chance":5.0, "armor":-3.0}, "color":Color("bf8cff")},
		{"name":"IRON REVENANT", "texture":"char_revenant", "description":"Armored undead hunter", "cost":60,
			"hp":145.0, "speed":250.0, "slots":6, "kinds":[], "weapon":"pistol",
			"stats":{"armor":10.0, "damage":-8.0, "hp_regen":0.8}, "color":Color("ff8d6d")},
		{"name":"BLADE DANCER", "texture":"char_dancer", "description":"Melee only. Fast, fragile, in your face", "cost":80,
			"hp":90.0, "speed":350.0, "slots":6, "kinds":["melee"], "weapon":"blade",
			"stats":{"damage":30.0, "attack_speed":15.0, "dodge":8.0}, "color":Color("ff6d8d")},
		{"name":"SIEGE ENGINE", "texture":"char_siege", "description":"Only three weapons, but each one hits like a truck", "cost":110,
			"hp":130.0, "speed":215.0, "slots":3, "kinds":[], "weapon":"rifle",
			"stats":{"damage":90.0, "attack_speed":-15.0, "armor":6.0}, "color":Color("ffd166")},
		{"name":"SCAVENGER", "texture":"char_scav", "description":"Feeble in a fight, rich in the shop", "cost":90,
