...
static func all() -> Array[Dictionary]:
	return [
		...
		{"id":"shotgun", "name":"VOID SHOTGUN", "price":16, "damage":9.0,
		...
		{"id":"smg", "name":"SPLINTER SMG", "price":12, "damage":6.5,
		...
		{"id":"rifle", "name":"ARC RIFLE", "price":20, "damage":43.0,
		...
		{"id":"lance", "name":"RIFT LANCE", "price":26, "damage":73.0,
		...
		{"id":"scatter", "name":"SCRAP CANNON", "price":18, "damage":15.0,
