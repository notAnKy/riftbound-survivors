...
- Source: https://game-icons.net/  (originals: https://github.com/game-icons/icons)
- License: **CC BY 3.0** — https://creativecommons.org/licenses/by/3.0/
- Attribution is *required* by this licence, unlike the CC0 assets above.

Each icon ships as a white glyph on a black square; the square is stripped so
the glyph can be tinted in-game. No other modification is made.
