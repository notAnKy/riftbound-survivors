...
Riftbound Survivors is free software: you may redistribute it and modify it
...
In plain terms: play it, read it, change it and share it freely — but anything
you build out of it has to stay open under this same licence. It cannot be
taken closed-source.
...
All artwork is original and generated by this repository, and is covered by the
licence above.

The bundled third-party assets keep their own licences, both compatible with
the GPL: sound effects and music are **CC0** (public domain), and the two fonts,
**Orbitron** and **Rajdhani**, are under the **SIL Open Font License**, whose
notices ship beside them in `assets/fonts/`.
