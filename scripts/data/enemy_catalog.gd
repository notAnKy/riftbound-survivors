...
# Tints are deliberately over 1.0: they multiply art that is already dark, and
# at 1.0 an enemy sat at the same value as the floor it was standing on.
...
static func _definitions() -> Array[Dictionary]:
	return [
		...
		{"id":"charger", "name":"CHARGER", "texture":"soldier", "behaviour":"charge",
			...
			"cooldown":1.2, "material":3, "tint":Color(1.30,1.12,0.78), "unlock_round":8,
...
static func _boss_definitions() -> Array[Dictionary]:
	return [
		{"id":"riftlord", "name":"RIFTLORD", "texture":"boss", "behaviour":"boss",
			...
			"cooldown":1.1, "material":25, "tint":Color(1.30,1.07,1.12), "unlock_round":5},
		{"id":"voidcaller", "name":"VOIDCALLER", "texture":"robot", "behaviour":"shooter",
			"hp":1.0, "speed":1.15, "radius":29.0, "scale":2.1, "damage":19.0,
			"cooldown":0.7, "material":25, "tint":Color(1.01,1.17,1.30), "unlock_round":10,
