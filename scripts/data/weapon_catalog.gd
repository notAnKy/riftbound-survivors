...
static func all() -> Array[Dictionary]:
	return [
		{"id":"pistol", "sound":"light", "name":"PLASMA PISTOL", "price":8, "damage":14.0,
			"cooldown":0.5, "range":330.0, "bullet_speed":700.0, "pierce":0,
			"shots":1, "spread":0.0, "color":Color("62e8ff"),
			"text":"Reliable energy bolts"},
		{"id":"wand", "sound":"medium", "name":"RUNE WAND", "price":14, "damage":24.0,
		...
		{"id":"shotgun", "sound":"heavy", "name":"VOID SHOTGUN", "price":16, "damage":9.0,
		...
		{"id":"smg", "sound":"light", "name":"SPLINTER SMG", "price":12, "damage":6.5,
		...
		{"id":"rifle", "sound":"heavy", "name":"ARC RIFLE", "price":20, "damage":43.0,
		...
		{"id":"lance", "sound":"heavy", "name":"RIFT LANCE", "price":26, "damage":73.0,
		...
		{"id":"scatter", "sound":"medium", "name":"SCRAP CANNON", "price":18, "damage":15.0,
